                    ...
                    <div className=''>
                        <div className='flex md:flex-row flex-col gap-1'>
                            <div className=' w-full md:w-1/2'>
                                <img className='object-cover w-full rounded-md md:h-[400px] sm:h-[300px]' src={property.propertyImage[0] ? property.propertyImage[0] : Image} alt=" 1 Image not found" />
                            ...
                            <div className=' w-full md:w-1/2'>
                                ...
                                <div className='w-full grid grid-cols-2 gap-2'>
                                    ...
                                    <img className='object-cover w-full rounded-md  h-[198px]' src={property.propertyImage[1] ? property.propertyImage[1] : Image} alt=" 1 Image not found" />


                                    <img className='object-cover w-full rounded-md  h-[198px]' src={property.propertyImage[2] ? property.propertyImage[2] : Image} alt=" 1 Image not found" />


                                    <img className='object-cover w-full rounded-md  h-[198px]' src={property.propertyImage[3] ? property.propertyImage[3] : Image} alt=" 1 Image not found" />


                                    <img className='object-cover w-full rounded-md  h-[198px]' src={property.propertyImage[4] ? property.propertyImage[4] : Image} alt=" Image not found" />
                                </div>
                                            ...
                                            {property.features.length > 0 ? (
                                                property.features.map((data, index) => (
                                                    <div key={index} className='flex items-center space-y-3'>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" viewBox="0 0 64 64" id="check">
                                                            <path fill="#222" d="M40.54 57.4H23.46a4.75 4.75 0 0 1-3.38-1.4L8 43.92a4.75 4.75 0 0 1-1.4-3.38V23.46A4.75 4.75 0 0 1 8 20.08L20.08 8a4.75 4.75 0 0 1 3.38-1.4h17.08A4.75 4.75 0 0 1 43.92 8L56 20.08a4.75 4.75 0 0 1 1.4 3.38v17.08a4.75 4.75 0 0 1-1.4 3.38L43.92 56a4.75 4.75 0 0 1-3.38 1.4ZM23.46 8.6a2.77 2.77 0 0 0-2 .82L9.42 21.49a2.77 2.77 0 0 0-.82 2v17.05a2.77 2.77 0 0 0 .82 2l12.07 12.04a2.77 2.77 0 0 0 2 .82h17.05a2.77 2.77 0 0 0 2-.82l12.04-12.07a2.77 2.77 0 0 0 .82-2V23.46a2.77 2.77 0 0 0-.82-2L42.51 9.42a2.77 2.77 0 0 0-2-.82Z"></path>
                                                            <path fill="#222" d="M28.58 40.56a1 1 0 0 1-.76-.38l-6.18-8A1 1 0 1 1 23.19 31l5.45 7c1.86-2 6.7-7.24 12.29-12.31a1 1 0 0 1 1.41.06 1 1 0 0 1-.06 1.42c-7 6.39-12.89 13-13 13a1 1 0 0 1-.7.39Z"></path>
                                                        </svg>
